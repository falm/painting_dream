...
/***/ function(module, exports, __webpack_require__) {
	...
	var _record = __webpack_require__(8);
	...
	var _arc = __webpack_require__(12);

	var _arc2 = _interopRequireDefault(_arc);

	var _graph2 = __webpack_require__(13);
	...
	var _triangle_stone = __webpack_require__(18);

	var _triangle_stone2 = _interopRequireDefault(_triangle_stone);

	var _organic = __webpack_require__(19);

	var _organic2 = _interopRequireDefault(_organic);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var GraphList = {
	    // 'circle': [Circle, Arc, Rotate, Particle, Organic],
	    'circle': [_circle2.default, _arc2.default, _rotate2.default, _particle2.default],
	    // 'rectangle' : [rectangle, BrushPainter, D],
	    'rectangle': [_brush2.default, _d2.default],
	    // 'triangle': [triangle, TriangleStone]
	    'triangle': [_triangle_stone2.default]
	};

	window.Painter = {};

	Painter.draw = function (filename, graph, index) {

	    _jquery2.default.getJSON(filename, function (data) {
	        var records = _lodash2.default.map(data, _record2.default.factory);
	        if (graph && index) {
	            GraphList[graph][index].run(records);
	        } else {
	            var _graph = _lodash2.default.flowRight(_lodash2.default.sample, _lodash2.default.flatten, _lodash2.default.values);
	            _graph(GraphList).run(records);
	        }
	    });
	};
	...
	(function () {
	    ...
	    if (true) {
	        Painter.draw(_config2.default.testFile, (0, _common.getQueryString)('g'), (0, _common.getQueryString)('i'));
	    }
	})();
...
/***/ function(module, exports) {
	...
	var Record = function () {
	    function Record(y, status, volume, x, h) {
	    ...
	    _createClass(Record, [{
	        ...
	        key: 'factory',
	        value: function factory(record) {
	            return new (Function.prototype.bind.apply(Record, [null].concat(_toConsumableArray(_.values(record)))))();
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getQueryString = exports.CanvasInit = exports.getContext = exports.draw = exports.readRecords = undefined;
	...
	function readRecords(fun) {
	    ...
	    (0, _jquery2.default)('#json-file').change(function () {
	...
	function draw(records, paintFunc) {
	    var i = 0;
	    var time = Math.floor(_config2.default.seconds / records.length);

	    console.log(records.length);
	    console.log(time);
	    var run_int = setInterval(run, time);
	    ...
	    function run() {
	        ...
	        if (records.length <= i || i >= _config2.default.seconds) {
	            clearInterval(run_int);
	        }
	    }
	}
	...
	function CanvasInit() {
	    var width = getParameterByName('width') || 500;
	    var height = getParameterByName('height') || 500;
...
/***/ function(module, exports) {
	...
	var Config = {
	    ...
	    seconds: 8000,
	    // testFile: 'test_data_large.json'
	    testFile: 'test_data_min.json'
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Circle(record) {
	    var self = this;
	    self.record = record;
	    self.ctx = (0, _common.getContext)();
	    self.tx = _lodash2.default.random(0, self.ctx.canvas.width);
	    self.ty = _lodash2.default.random(0, self.ctx.canvas.height);
	    self.x = 0;
	    self.y = 0;
	    self.vx = 5;
	    self.vy = 2;
	    ...
	    self.checkExtrema = function (func) {
	    ...
	    self.radius = function () {
	        return self._radius = self._radius || self.record.h / 20 + _lodash2.default.random(10);
	    };
	}

	Circle.run = function (records) {
	    (0, _common.draw)(records, Circle.render);
	};

	Circle.render = function (record) {

	    var circle = new Circle(record);
	    circle.draw();
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Arc = function () {
	    function Arc(record) {
	        ...
	        this.record = record;
	        this.ctx = (0, _common.getContext)();
	        this.x = this.ctx.canvas.width / 2 + 50;
	        this.y = this.ctx.canvas.height - 50;
	        this.radius = _lodash2.default.random(750); // 圆弧半径
	        this.startAngle = _lodash2.default.random(record.x); // 开始点
	        this.endAngle = Math.PI * 2 + record.y;
	        this.lineWidth = _lodash2.default.random(5, true);
	    }
	    ...
	    _createClass(Arc, [{
	        ...
	        key: 'render',
	        value: function render(record) {
	            new Arc(record).draw();
	        }
	    }, {
	        key: 'run',
	        value: function run(records) {
	            (0, _common.draw)(records, Arc.render);
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.triangle = exports.rectangle = undefined;
	...
	function rectangle(record) {
	    var ctx = (0, _common.getContext)();
	    var x = _lodash2.default.random(0, ctx.canvas.width);
	    var y = _lodash2.default.random(0, ctx.canvas.height);
	...
	triangle.run = function (records) {
	    (0, _common.draw)(records, triangle);
	};

	rectangle.run = function (records) {
	    (0, _common.draw)(records, rectangle);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	Brush.prototype.grow = function () {
	    ...
	    var context = (0, _common.getContext)();
	...
	function BrushPainter(records) {
	    ...
	    self.init = function () {
	        self.context = (0, _common.getContext)();
	...
	BrushPainter.run = function (records) {
	    new BrushPainter(records).draw();
	};

	exports.default = BrushPainter;
...
/***/ function(module, exports, __webpack_require__) {
	...
	Rotate.run = function (records) {
	    var rotate = new Rotate(records);
	    rotate.draw();
	};
	...
	var D = function () {
	    ...
	    _createClass(D, [{
	        ...
	        value: function getColor() {
	            ...
	            var color = this.recordItercount >= this.records.length ? 'red' : this.records[this.recordItercount].color();
	            this.increase();
	            return color;
	        }
	    }, {
	        ...
	        value: function increase() {
	            this.step = this.step || Math.floor(this.records.length / (this.width * this.height / (this.denseness * this.denseness)));
	        ...
	        value: function start() {
	            ...
	            for (var height = 0; height < this.height; height += this.denseness) {
	                for (var width = 0; width < this.width; width += this.denseness) {
	        ...
	        value: function draw() {
	            ...
	            _lodash2.default.reduce(this.points, function (tx, point) {
	                _this.ctx.save();
	                // this.ctx.rotate(Math.PI*2/9);
	                _this.ctx.fillStyle = point.c;
	                _this.ctx.globalAlpha = 0.5;
	                _this.ctx.fillRect(point.x, point.y, _this.denseness, _this.denseness);
	                _this.ctx.strokeRect(point.x, point.y, _this.denseness, _this.denseness);
	                _this.ctx.restore();
	            }, 0);
	        }
	    }], [{
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Particle = function () {
	    ...
	    _createClass(Particle, [{
	        ...
	        key: "setParticles",
	        value: function setParticles(records) {
	            ...
	            for (var h = 0; h < this.devideY; h += 1) {
	                for (var w = 0; w < this.devideX; w += 1) {
	                    ...
	                    if (randomNum === 0 || randomNum === 2) {
	                        this.largeParticles.push(new Particle(x, y, this.largeSize[Math.floor(Math.random() * this.largeSize.length)], _.sample(records.awake).color()));
	                    }

	                    if (randomNum === 0 || randomNum === 1) {
	                        this.middleParticles.push(new Particle(x, y, this.middleSize[Math.floor(Math.random() * this.middleSize.length)], _.sample(records.light).color()));
	                    }
	                    if (randomNum === 1 || randomNum === 2) {
	                        this.smallParticles.push(new Particle(x, y, this.smallSize[Math.floor(Math.random() * this.smallSize.length)], _.sample(records.deep).color()));
	                    }
	                }
	            }
	        }
	        ...
	        key: "checkDistance",
	        value: function checkDistance(array) {
	            for (var i = 0, len = array.length; i < len - 1; i++) {
	                for (var j = i + 1; j < len; j++) {
	                    ...
	                    if (pDistance < 20000 && array === this.largeParticles || pDistance < 15000 && array === this.middleParticles || pDistance < 9000 && array === this.smallParticles) {
	        ...
	        value: function run(records) {
	            var recordHash = {
	                deep: _.filter(records, function (r) {
	                    return r.isDeep();
	                }),
	                light: _.filter(records, function (r) {
	                    return r.isLight();
	                }),
	                awake: _.filter(records, function (r) {
	                    return r.isAwake();
	                })
	            };
	...
	Particle.context = (0, _common.getContext)();
	Particle.canvas = (0, _common.getContext)().canvas;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TriangleStone = function () {
	    function TriangleStone(records) {
	        _classCallCheck(this, TriangleStone);
	    ...
	    _createClass(TriangleStone, [{
	        ...
	        value: function render() {
	            ...
	            var ctx = this.ctx;
	            var hueStart = this.rnd(0, 360);
	            var triSide = 40;
	            var halfSide = triSide / 2;
	            var rowHeight = Math.floor(triSide * this.heightScale);
	            var columns = Math.ceil(this.canvasWidth / triSide) + 1;
	            var rows = Math.ceil(this.canvasHeight / rowHeight);
	    ...
	    return TriangleStone;
	}();

	exports.default = TriangleStone;
...
/***/ function(module, exports, __webpack_require__) {
	...
	Organic.run = function (records) {
	    var o = new Organic(records);
	    o.init();
	};

	exports.default = Organic;
